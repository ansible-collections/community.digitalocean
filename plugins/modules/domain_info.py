...
description:
    ...
    - This module was called C(domain_facts) before Ansible 2.9. The usage did not change.
...
- name: Gather information about all domains
  community.digitalocean.domain_info:
...
def main():
    ...
    if module._name in ('domain_facts', 'community.digitalocean.domain_facts'):
        module.deprecate("The 'domain_facts' module has been renamed to 'domain_info'",
