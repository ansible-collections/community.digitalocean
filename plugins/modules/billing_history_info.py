...
short_description: Get current user billing history information

version_added: 2.0.0

description:
  - This module gets the current user billing history information.
...
billing_history:
  ...
  sample:
    billing_history:
      description: List of billing history activities.
      returned: success
      type: list
      entries: dict
      sample:
        ...
        type: Invoice
    meta:
      description: Billing history metadata.
      returned: success
      type: dict
      sample:
        total: Total number of billing history entries.
        type: int
        sample: 5
    links:
      description: Links to next and last results.
      returned: success
      type: dict
      sample:
